...
p2 <- DimPlot(pbmc, reduction = "wnn.umap", group.by = "RNA_snn_res.1.1", label = TRUE, label.size = 2.5, repel = TRUE) + ggtitle("RNA clusters res=1.1")
